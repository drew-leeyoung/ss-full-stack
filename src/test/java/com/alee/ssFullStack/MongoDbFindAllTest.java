...
@SpringBootTest
public class MongoDbFindAllTest {
    ...
    @Test
    public void mongoDbRepositoryFindAllTest() {
        // query for all products and assert
        ...
        assertTrue(products.get(1).getName().equals("The Best Water"));
